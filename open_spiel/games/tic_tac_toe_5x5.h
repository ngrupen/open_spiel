...
#ifndef OPEN_SPIEL_GAMES_TIC_TAC_TOE_5x5_H_
#define OPEN_SPIEL_GAMES_TIC_TAC_TOE_5x5_H_
...
class TicTacToe5x5State : public State {
 public:
  TicTacToe5x5State(std::shared_ptr<const Game> game);

  TicTacToe5x5State(const TicTacToe5x5State&) = default;
  TicTacToe5x5State& operator=(const TicTacToe5x5State&) = default;
...
// Game object.
class TicTacToe5x5Game : public Game {
 public:
  explicit TicTacToe5x5Game(const GameParameters& params);
