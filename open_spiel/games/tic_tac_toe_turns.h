...
#ifndef OPEN_SPIEL_GAMES_TIC_TAC_TOE_TURNS_H_
#define OPEN_SPIEL_GAMES_TIC_TAC_TOE_TURNS_H_
...
class TicTacToeTurnsState : public State {
 public:
  TicTacToeTurnsState(std::shared_ptr<const Game> game);

  TicTacToeTurnsState(const TicTacToeTurnsState&) = default;
  TicTacToeTurnsState& operator=(const TicTacToeTurnsState&) = default;
...
// Game object.
class TicTacToeTurnsGame : public Game {
 public:
  explicit TicTacToeTurnsGame(const GameParameters& params);
...
#endif  // OPEN_SPIEL_GAMES_TIC_TAC_TOE_TURNS_H_
