...
#ifndef OPEN_SPIEL_GAMES_TIC_TAC_TOE_RAND_START_H_
#define OPEN_SPIEL_GAMES_TIC_TAC_TOE_RAND_START_H_
...
class TicTacToeRandStartState : public State {
 public:
  TicTacToeRandStartState(std::shared_ptr<const Game> game);

  TicTacToeRandStartState(const TicTacToeRandStartState&) = default;
  TicTacToeRandStartState& operator=(const TicTacToeRandStartState&) = default;
...
// Game object.
class TicTacToeRandStartGame : public Game {
 public:
  explicit TicTacToeRandStartGame(const GameParameters& params);
...
#endif  // OPEN_SPIEL_GAMES_TIC_TAC_TOE_RAND_START_H_
