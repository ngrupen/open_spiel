...
#ifndef OPEN_SPIEL_GAMES_TIC_TAC_TOE_4x4_H_
#define OPEN_SPIEL_GAMES_TIC_TAC_TOE_4x4_H_
...
class TicTacToe4x4State : public State {
 public:
  TicTacToe4x4State(std::shared_ptr<const Game> game);

  TicTacToe4x4State(const TicTacToe4x4State&) = default;
  TicTacToe4x4State& operator=(const TicTacToe4x4State&) = default;
...
// Game object.
class TicTacToe4x4Game : public Game {
 public:
  explicit TicTacToe4x4Game(const GameParameters& params);
  int NumDistinctActions() const override { return kNumCells; }
  std::unique_ptr<State> NewInitialState() const override {
    return std::unique_ptr<State>(new TicTacToe4x4State(shared_from_this()));
  }
...
#endif  // OPEN_SPIEL_GAMES_TIC_TAC_TOE_4x4_H_
